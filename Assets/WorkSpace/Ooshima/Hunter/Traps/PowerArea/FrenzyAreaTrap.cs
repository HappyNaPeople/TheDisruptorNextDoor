...
public class FrenzyAreaTrap : Trap
{
...
public class PowerAreaEffect : MonoBehaviour, IPlayerMovementModifier
{
    ...
    public void Init(Runner runner, FrenzyAreaTrap trap, float durationAfterExit, float speedMultiplier, float dampingValue)
    {
        this.Runner = runner;
        this.trap = trap;
