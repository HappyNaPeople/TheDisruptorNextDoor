...
public class PlayerInputData : MonoBehaviour
{
    ...
    public bool wasPunchPressedThisFrame;
    ...
    private void LateUpdate()
    {
        ...
        wasPunchPressedThisFrame = false;
        wasJumpReleasedThisFrame = false;
    }
